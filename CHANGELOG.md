...
- Publish a real latest container tag
...
- Refresh Thor only when upstream llama.cpp moves
...
- Make Thor deployment and Qwen MTP support production-safe
...
- Keep Thor production deployment outside CI
...
- Link published images to the public repository
...
- Authenticate GitHub API checks during image publishing
...
- Make copied Hugging Face links work everywhere models are downloaded
...
- Let discovery clients see the model native context capacity
...
- Make model discovery report one native context capacity
...
- Honor model-native context when no override is configured
